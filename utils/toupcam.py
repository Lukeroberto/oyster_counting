...
TOUPCAM_FLAG_PUTTEMPERATURE      = 0x00000800          # support to put the target temperature of the sensor
...
TOUPCAM_OPTION_PROCESSMODE           = 0x03       # 0 = better image quality, more cpu usage. this is the default value
...
TOUPCAM_OPTION_AFMODE                = 0x25       # auto focus mode (0:manul focus; 1:auto focus; 2:onepush focus; 3:conjugate calibration)
...
# get the version of this dll, which is: 46.16443.2020.0119
    @classmethod
    def Version(cls):
        cls.__initlib()
...
# Auto White Balance, Temp/Tint Mode
    def AwbOnePush(self):
        self.__lib.Toupcam_AwbOnePush(self.__h, None, None)
...
# Auto White Balance, RGB Gain Mode
    ...
    def AbbOnePush(self):
        self.__lib.Toupcam_AbbOnePush(self.__h, None, None)

    def FfcOnePush(self):
        self.__lib.Toupcam_FfcOnePush(self.__h)

    def DfcOnePush(self):
        self.__lib.Toupcam_DfcOnePush(self.__h)
...
# for each device found, it will take about 3 seconds
    ...
    def __initlib(cls):
        if cls.__lib is None:
            ...
            cls.__lib.Toupcam_AwbOnePush.restype = ctypes.c_int
            cls.__lib.Toupcam_AwbOnePush.errcheck = cls.__errcheck
            cls.__lib.Toupcam_AwbOnePush.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
            ...
            cls.__lib.Toupcam_AbbOnePush.restype = ctypes.c_int
            cls.__lib.Toupcam_AbbOnePush.errcheck = cls.__errcheck
            cls.__lib.Toupcam_AbbOnePush.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
            cls.__lib.Toupcam_FfcOnePush.restype = ctypes.c_int
            cls.__lib.Toupcam_FfcOnePush.errcheck = cls.__errcheck
            cls.__lib.Toupcam_FfcOnePush.argtypes = [ctypes.c_void_p]
            cls.__lib.Toupcam_DfcOnePush.restype = ctypes.c_int
            cls.__lib.Toupcam_DfcOnePush.errcheck = cls.__errcheck
            cls.__lib.Toupcam_DfcOnePush.argtypes = [ctypes.c_void_p]
